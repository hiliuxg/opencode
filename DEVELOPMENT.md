...
docker buildx build --platform linux/amd64 \
      -t opencode-v125-03211230 \
      --load \
      . 

docker save -o opencode-v125-03211230.tar opencode-v125-03211230

 
sudo  docker load -i opencode-v125-03211230.tar
