...
export const dict = {
  ...
  "skills.upload.title": "发布 {{name}}",
  "skills.upload.catalog": "分类",
  "skills.upload.submit": "发布",
  "skills.upload.uploading": "发布中...",
  "skills.upload.success.title": "发布成功",
  "skills.upload.success.description": "成功将 {{name}} 发布到技能市场",
  "skills.upload.failed.title": "发布失败",
