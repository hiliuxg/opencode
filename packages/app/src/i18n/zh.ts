...
export const dict = {
  ...
  "session.tab.review": "文件变更",
  "session.tab.context": "上下文",
  "session.tab.closeAll": "全部关闭",
  ...
  "conversation.title": "我的会话",
  "conversation.search": "搜索会话",
  "conversation.category.title": "会话分类",
  "conversation.category.new": "新建分类",
  "conversation.category.create": "创建",
  "conversation.category.rename": "重命名分类",
  "conversation.category.deleteConfirm": "删除分类“{{name}}”？",
  "conversation.category.name": "分类名称",
  "conversation.category.placeholder": "分类名称",
  "conversation.category.temp": "临时会话",
  ...
  "conversation.section.expand": "展开",
  "conversation.section.collapse": "收起",
  "conversation.session.pin": "置顶",
  "conversation.session.unpin": "取消置顶",
  "conversation.session.move": "移动分类",
  "conversation.session.moveBack": "返回",
  "conversation.session.unarchive": "取消归档",
  "conversation.session.rename": "重命名会话",
  "conversation.session.name": "会话名称",
  ...
  "fileTree.menu.preview": "浏览器预览",
  "fileTree.menu.share": "生成共享链接",
  ...
  "fileTree.toast.copyFailed": "复制失败",
  "fileTree.toast.copySuccess": "复制完成",
  "fileTree.toast.copyReady": "已复制到剪贴板",
  "fileTree.toast.cutReady": "已准备移动",
  "fileTree.toast.clipboardFailed": "更新剪贴板失败",
  "fileTree.toast.clipboardEmpty": "剪贴板中没有路径",
  "fileTree.toast.pasteFailed": "粘贴失败",
  "fileTree.toast.pasteBlocked": "不能把文件夹粘贴到自身内部",
  "fileTree.toast.pasteUnavailable": "此处不可粘贴",
  "fileTree.toast.shareFailed": "生成共享链接失败",
  "fileTree.toast.shareSuccess": "共享链接已复制到剪贴板",
  ...
  "scheduler.create.model.label": "选择模型",
  "scheduler.create.model.placeholder": "选择模型",
  "scheduler.create.frequency.daily": "按天",
  "scheduler.create.frequency.hourly": "按小时",
  "scheduler.create.frequency.weekly": "按周",
  "scheduler.create.frequency.monthly": "按月",
  "scheduler.create.frequency.everyHour": "每 {{v}} 小时",
  "scheduler.create.frequency.minute": "分钟",
  "scheduler.create.frequency.hour": "小时",
  "scheduler.create.frequency.dateOfMonth": "日",
  "scheduler.create.frequency.everyMinute": "第 {{v}} 分钟",
  "scheduler.create.frequency.dayOfWeek.1": "周一",
  "scheduler.create.frequency.dayOfWeek.2": "周二",
  "scheduler.create.frequency.dayOfWeek.3": "周三",
  "scheduler.create.frequency.dayOfWeek.4": "周四",
  "scheduler.create.frequency.dayOfWeek.5": "周五",
  "scheduler.create.frequency.dayOfWeek.6": "周六",
  "scheduler.create.frequency.dayOfWeek.7": "周日",
  ...
  "scheduler.create.update": "更新任务",
  "scheduler.create.updating": "更新中...",
  "scheduler.create.updateSuccess": "任务已更新",
  "scheduler.create.updateFailed": "更新失败",
  "scheduler.create.cancelEdit": "取消编辑",
