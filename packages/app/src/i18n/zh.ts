...
export const dict = {
  ...
  "skills.gitClone.modal.title": "获取技能",
  "skills.gitClone.modal.description": "输入 Git 仓库地址以克隆技能",
  "skills.gitClone.modal.urlLabel": "Git 地址",
  "skills.gitClone.modal.placeholder": "https://cnb.tmeoa.com/kudata-skills/xxx.git",
  ...
  "skills.kb.create": "创建知识库",
  "skills.kb.form.title": "创建知识库",
