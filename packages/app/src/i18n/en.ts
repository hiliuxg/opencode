export const dict = {
  ...
  "skills.upload.title": "Publish {{name}}",
  "skills.upload.catalog": "Catalog",
  "skills.upload.submit": "Publish",
  "skills.upload.uploading": "Publishing...",
  "skills.upload.success.title": "Publish successful",
  "skills.upload.success.description": "Successfully published {{name}} to Hub",
  "skills.upload.failed.title": "Publish failed",
