export const dict = {
  ...
  "command.skill.choose.description": "Select a skill to use",
  ...
  "session.tab.closeAll": "Close all",
  ...
  "conversation.title": "My conversations",
  "conversation.search": "Search conversations",
  "conversation.category.title": "Conversation categories",
  "conversation.category.new": "New category",
  "conversation.category.create": "Create",
  "conversation.category.rename": "Rename category",
  "conversation.category.deleteConfirm": 'Delete category "{{name}}"?',
  "conversation.category.name": "Category name",
  "conversation.category.placeholder": "Category name",
  "conversation.category.temp": "Temporary sessions",
  ...
  "conversation.section.expand": "Expand",
  "conversation.section.collapse": "Collapse",
  "conversation.session.pin": "Pin",
  "conversation.session.unpin": "Unpin",
  "conversation.session.move": "Move category",
  "conversation.session.moveBack": "Back",
  "conversation.session.unarchive": "Unarchive",
  "conversation.session.rename": "Rename conversation",
  "conversation.session.name": "Conversation name",
  ...
  "fileTree.menu.deleteFolder": "Delete folder",
  "fileTree.menu.copy": "Copy",
  "fileTree.menu.cut": "Cut",
  "fileTree.menu.paste": "Paste",
  "fileTree.menu.preview": "Preview in browser",
  "fileTree.menu.share": "Generate share link",
  "fileTree.menu.newFile": "New file",
  "fileTree.menu.newFolder": "New folder",
  "fileTree.delete.title": "Delete",
  "fileTree.delete.confirmFile": 'Delete "{{name}}"?',
  "fileTree.delete.confirmFolder": 'Delete folder "{{name}}" and all its contents?',
  "fileTree.upload.start": "Upload started",
  "fileTree.upload.progress": "Uploading...",
  "fileTree.upload.success": "Upload complete",
  "fileTree.upload.error": "Upload failed",
  "fileTree.toast.writeFailed": "Failed to create file",
  "fileTree.toast.deleteFailed": "Failed to delete",
  "fileTree.toast.deleteSuccess": "Deleted",
  "fileTree.toast.renameFailed": "Failed to rename",
  "fileTree.toast.mkdirFailed": "Failed to create folder",
  "fileTree.toast.downloadFailed": "Failed to download",
  "fileTree.toast.copyFailed": "Failed to copy",
  "fileTree.toast.copySuccess": "Copied",
  "fileTree.toast.copyReady": "Copied to clipboard",
  "fileTree.toast.cutReady": "Ready to move",
  "fileTree.toast.clipboardFailed": "Failed to update clipboard",
  "fileTree.toast.clipboardEmpty": "Clipboard does not contain a path",
  "fileTree.toast.pasteFailed": "Paste failed",
  "fileTree.toast.pasteBlocked": "Cannot paste a folder into itself",
  "fileTree.toast.pasteUnavailable": "Paste is unavailable here",
  "fileTree.toast.shareFailed": "Failed to generate share link",
  "fileTree.toast.shareSuccess": "Share link copied to clipboard",

  "fileTree.toolbar.refresh": "Refresh file tree",
  "fileTree.toolbar.newFile": "New file",
  "fileTree.toolbar.newFolder": "New folder",
  "fileTree.toolbar.newFilePlaceholder": "filename.ext",
  "fileTree.toolbar.newFolderPlaceholder": "folder-name",
  ...
  "apiDoc.step4.title": "4. Open Session in Browser",
  "apiDoc.step4.hint": "Replace <session_id> with the id returned in step 2.",
  ...
  "skills.delete.confirm": "Delete {{name}}?",
  ...
  "skills.delete.invalidPath": "Invalid skill path (cannot delete project root).",
  "skills.delete.outsideWorkspace": "Only skills within the current project directory can be deleted.",
  "skills.upload.title": "Push changes to skill hub {{name}}",
  "skills.upload.catalog": "Category",
  "skills.upload.submit": "Push to hub",
  "skills.upload.uploading": "Pushing...",
  "skills.upload.success.title": "Push successful",
  "skills.upload.success.description": "Successfully pushed {{name}} to skill hub, pending review",
  "skills.upload.failed.title": "Push failed",
  "skills.push.tooltip": "Push changes to skill hub",
  "skills.push.modal.title": "Push changes to skill hub: {{name}}",
  "skills.push.modal.description": "Please describe the changes in this push",
  "skills.push.commitMessage.label": "Commit message",
  "skills.push.commitMessage.placeholder": "Describe the changes...",
  "skills.push.confirm": "Confirm push",
  "skills.push.noChanges.title": "Nothing to push",
  "skills.push.noChanges.description": "No changes to commit on current branch",
  "skills.push.success.title": "Push successful",
  "skills.push.success.description": "Skill pushed to remote, copy the link to send to admin for review",
  "skills.push.success.descriptionWithName": "Skill {{name}} pushed to remote, send the link to admin for review",
  "skills.push.failed.title": "Push failed",
  "skills.push.success.dialog.title": "Push successful",
  "skills.push.success.dialog.description": "Copy the link below to send to admin for review",
  "skills.push.success.dialog.reviewLink": "Review link",
  "skills.push.success.dialog.reviewHint": "Changes will be merged to the skill hub after review.",
  ...
  "skills.pull.tooltip": "Pull latest skill from hub (overwrites local changes)",
  "skills.pull.confirm": "Pulling latest skill from hub will completely overwrite local changes. Continue?",
  "skills.pull.success.title": "Pull successful",
  "skills.pull.success.description": "Successfully pulled latest skill {{name}} from hub",
  "skills.pull.failed.title": "Pull failed",
  "skills.updates.check": "Check for Updates",
  "skills.updates.checking": "Checking...",
  "skills.updates.check.done.title": "Update check complete",
  "skills.updates.check.upToDate": "All skills are up to date",
  "skills.updates.banner": "{{count}} skill(s) have updates available",
  "skills.updates.updateAll": "Update All ({{count}})",
  "skills.updates.updating": "Updating...",
  "skills.updates.behind": "{{behind}} commits behind {{branch}}",
  "skills.updates.updateAll.confirm": "Pull latest for all {{count}} skill(s)? Local changes will be overwritten.",
  "skills.updates.updateAll.done": "{{count}} skill(s) updated successfully",
  "skills.updates.tooltip": "{{count}} skill(s) have updates",
  "skills.download": "Download locally",
  "skills.gitClone.button": "Get skill",
  "skills.market.web": "Skill Hub",
  "skills.market.title": "Get skills",
  "skills.market.description": "Select one or more skills from the hub to clone to your project. Click a row to select or deselect.",
  "skills.market.cloneSuccess": "Successfully cloned {{count}} skills",
  "skills.market.cloneFailedAt": 'Failed to clone "{{name}}": {{message}}',
  "skills.market.search.placeholder": "Search by name or description",
  "skills.market.loading": "Loading skill hub...",
  "skills.market.empty": "No matching skills",
  "skills.market.listEmpty": "No skills available",
  "skills.gitClone.cloning": "Cloning...",
  "skills.gitClone.confirm": "Confirm",
  "skills.gitClone.success.title": "Success",
  "skills.gitClone.success.description": "Skill repository cloned",
  ...
  "skills.kb.form.cluster": "Select Cluster",
  "skills.kb.form.cluster.bi-cloud": "Cloud Cluster (bi-cloud)",
  "skills.kb.form.cluster.quku": "Music Library (quku)",
  "skills.kb.form.cluster.newsong": "New Song Recommendation (newsong)",
  "skills.kb.form.cluster.bi-ssc": "Separated Storage (bi-ssc)",
  "skills.kb.form.cluster.recommend": "Recommendation Cluster (recommend)",
  "skills.kb.form.cluster.olap": "OLAP Cluster (olap)",
  "skills.kb.form.cluster.realtime": "Realtime Cluster (realtime)",
  "skills.kb.form.cluster.fx": "FanXing Live (fx)",
  "skills.kb.form.tables": "Required Tables",
  "skills.kb.form.tables.placeholder": "Enter table name and press Enter to add",
  "skills.kb.form.tables.empty": "Add at least one table",
  "skills.kb.form.catalog": "Business Domain",
  "skills.kb.form.catalog.other": "Other",
  "skills.kb.form.account.unknown": "Unrecognized",
  "skills.kb.form.purpose": "Knowledge Base Purpose",
  "skills.kb.form.purpose.placeholder": "e.g. For long-audio data analysis and queries",

  "common.create": "Create",
  "common.error.title": "Error",
  "common.error.noAccount": "No account found to execute",
  "common.chart": "Chart",
  "common.table": "Table",
  "common.date": "Date",
  "dashboard.allDirs.title": "All Directories",
  "dashboard.allDirs.sub": "All workspace directories with session stats",
  "dashboard.dailyDirs.title": "Daily Active Directories",
  ...
  "session.header.download.noFile": "Open a file first",
  ...
  "settings.tokenManagement.copySuccess": "Token copied to clipboard",
  "settings.tokenManagement.copyFailed": "Failed to copy token",
  "settings.tokenManagement.noConfig": "No opencode.json found in current directory. Tokens are configured in the provider section of opencode.json.",
  "settings.tokenManagement.setupGuide": "Setup guide",
  "settings.tokenManagement.step1": "Visit",
  "settings.tokenManagement.step2": 'Copy the "Access Token" on the page',
  "settings.tokenManagement.step3": "Paste the token below and click save",
  "settings.tokenManagement.inputLabel": "Access token",
  "settings.tokenManagement.inputPlaceholder": "Paste your access token...",
  "settings.tokenManagement.tokenRequired": "Please enter a token",
  "settings.tokenManagement.noDirectory": "No directory available",
  "settings.tokenManagement.saveSuccess": "Config saved successfully",
  "settings.tokenManagement.updateSuccess": "Config updated successfully",
  "settings.tokenManagement.saveFailed": "Failed to save config",
  "settings.tokenManagement.noProviders": "No providers configured in opencode.json",
  "settings.tokenManagement.updateToken": "Update token",
  "settings.tokenManagement.addToken": "Add token",
  "settings.tokenManagement.status.configured": "Token configured",
  "settings.tokenManagement.status.empty": "Token not set",

  "scheduler.dialog.title": "Scheduler",
  "scheduler.tab.create": "New task",
  "scheduler.tab.edit": "Edit task",
  "scheduler.tab.jobs": "Task list",
  "scheduler.tab.history": "Execution history",
  "scheduler.create.name.label": "Task name",
  "scheduler.create.name.placeholder": "e.g. Daily analytics insight",
  "scheduler.create.frequency.label": "Frequency",
  "scheduler.create.model.label": "Model",
  "scheduler.create.model.placeholder": "Select model",
  "scheduler.create.frequency.daily": "Daily",
  "scheduler.create.frequency.hourly": "Hourly",
  "scheduler.create.frequency.weekly": "Weekly",
  "scheduler.create.frequency.monthly": "Monthly",
  "scheduler.create.frequency.everyHour": "Every {{v}} hours",
  "scheduler.create.frequency.minute": "min",
  "scheduler.create.frequency.hour": "hr",
  "scheduler.create.frequency.dateOfMonth": "day",
  "scheduler.create.frequency.everyMinute": "At minute {{v}}",
  "scheduler.create.frequency.dayOfWeek.1": "Mon",
  "scheduler.create.frequency.dayOfWeek.2": "Tue",
  "scheduler.create.frequency.dayOfWeek.3": "Wed",
  "scheduler.create.frequency.dayOfWeek.4": "Thu",
  "scheduler.create.frequency.dayOfWeek.5": "Fri",
  "scheduler.create.frequency.dayOfWeek.6": "Sat",
  "scheduler.create.frequency.dayOfWeek.7": "Sun",
  "scheduler.create.prompt.label": "Prompt",
  "scheduler.create.prompt.placeholder": "Review yesterday's commits and summarize",
  "scheduler.create.submit": "Create task",
  "scheduler.create.submitting": "Creating...",
  "scheduler.create.success": "Scheduled task created",
  "scheduler.create.failed": "Failed to create",
  "scheduler.create.error.missingFields": "Please fill in task name and prompt",
  "scheduler.create.update": "Update task",
  "scheduler.create.updating": "Updating...",
  "scheduler.create.updateSuccess": "Task updated",
  "scheduler.create.updateFailed": "Failed to update",
  "scheduler.create.cancelEdit": "Cancel edit",
  ...
  "scheduler.jobs.action.run": "Run now",
  "scheduler.jobs.action.edit": "Edit",
  "scheduler.jobs.action.delete": "Delete",
  "scheduler.jobs.action.enable": "Enable",
  "scheduler.jobs.action.disable": "Disable",
  "scheduler.history.empty": "No execution records",
