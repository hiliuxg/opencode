export const dict = {
  ...
  "skills.delete.invalidPath": "This skill path is invalid (cannot delete the project root).",
  "skills.delete.outsideWorkspace": "Only skills under this project can be deleted from here.",
  ...
  "skills.market.loading": "Loading marketplace…",
  "skills.market.empty": "No skills match your search",
  ...
  "skills.kb.form.account.unknown": "Unknown",
  ...
  "settings.tokenManagement.description": "Manage API tokens from your opencode.json configuration.",
  ...
  "settings.tokenManagement.noConfig": "No opencode.json found in the current directory. Tokens are configured in the provider section of opencode.json.",
  "settings.tokenManagement.setupGuide": "Setup Guide",
  "settings.tokenManagement.step1": "Visit",
  "settings.tokenManagement.step2": "Copy the '访问令牌' (Access Token)",
  "settings.tokenManagement.step3": "Paste it below and click Save",
  "settings.tokenManagement.inputLabel": "Access Token",
  "settings.tokenManagement.inputPlaceholder": "Paste your access token here...",
  "settings.tokenManagement.tokenRequired": "Please enter a token",
  "settings.tokenManagement.noDirectory": "No directory available",
  "settings.tokenManagement.saveSuccess": "Configuration saved successfully",
  "settings.tokenManagement.updateSuccess": "Configuration updated successfully",
  "settings.tokenManagement.saveFailed": "Failed to save configuration",
