...
export const dict = {
  ...
  "ui.fileMedia.sheet.truncated": "仅显示前 {{rows}} 行和 {{cols}} 列。",
  ...
  "ui.lineComment.placeholder": "想怎么改",
  "ui.lineComment.submit": "修改",
  ...
  "ui.tool.get_file_link": "获取文件链接",
  "ui.tool.get_file_link.share": "共享链接",
  "ui.tool.get_file_link.download": "下载链接",
